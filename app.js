...
const bible = require("./bible_handler");
      ...
      entry.messaging.forEach(event => {
        if (event.message && !event.message.is_echo) {
          ...
          if (attachments) {
            ...
            wit
              .message(text)
              .then(res => bible.bibleResponse(res))
              .then(msg => {
...
app.get("/tezt", (req, res) => {
  // let promise = bible.getVerse(0, 1, 10) //handleNrOfBooks();  
  // promise.then(
  //   function(result) {
  //     res.send(result);
  // },
